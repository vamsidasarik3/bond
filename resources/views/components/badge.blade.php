...
@php
    if ($type === 'plot') {
        ...
        $styles = match(strtolower($status)) {
            ...
            'interested' => 'bg-indigo-50 text-indigo-700 border-indigo-200/80',
            'site_visit_scheduled' => 'bg-teal-50 text-teal-700 border-teal-200/80',
            'site_visit_completed' => 'bg-cyan-50 text-cyan-700 border-cyan-200/80',
            'follow_up_required' => 'bg-amber-50 text-amber-700 border-amber-200/80',
            'converted' => 'bg-emerald-50 text-emerald-700 border-emerald-200/80',
            'not_interested' => 'bg-rose-50 text-rose-700 border-rose-200/80',
            'in_progress' => 'bg-amber-50 text-amber-700 border-amber-200/80',
            'closed' => 'bg-slate-100 text-slate-700 border-slate-300/80',
            default => 'bg-slate-50 text-slate-700 border-slate-200/80',
        };
        $dotColor = match(strtolower($status)) {
            'new' => 'bg-blue-500',
            ...
            'site_visit_scheduled' => 'bg-teal-500',
            'site_visit_completed' => 'bg-cyan-500',
            'follow_up_required' => 'bg-amber-500',
