    ...
    <div class="subfooter-bar">
        <div class="container">
            <div class="row align-items-center justify-content-between g-2">
                <div class="col-lg-5 col-md-12 text-center text-lg-start font-copperplate">
                    &copy; {{ date('Y') }} NAVAGRUHA INFRA DEVELOPERS. All rights reserved.
                </div>
                <div class="col-lg-3 col-md-6 text-center text-white-50">
                    HMDA Final Sanction &bull; Telangana RERA Certified
                </div>
                <div class="col-lg-4 col-md-6 text-center text-lg-end text-white-50">
